  ...
  if (loading) {
    return (
      <div className="courses-page courses-state">
        ...
        <h2>Preparing your learning library...</h2>

        <p>
          Loading programs designed to build organizational capability.
        </p>
      </div>
    );
  }
    ...
    <div className="courses-page">
      ...
      <section className="courses-hero">
        ...
        <div className="courses-hero-content">
          ...
          <p>
            Explore curated learning programs designed to strengthen
            the competencies that matter to your role and growth.
          </p>
...
function CourseCard({
  ...
  const title = course.title || "Learning Program";
    ...
    >
      ...
      <div className="course-card-content">
        ...
        <div className="course-category">
          {course.category || "Capability Development"}
        </div>
